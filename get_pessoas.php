<?php
	...
	{	
		while($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC))
		{
			...
			echo '<a href="#" class="list-group-item">';
				...
				echo '<p class="list-group-item-text pull-right">';
					...
					echo '<button type="button" id="btn_seguir_'.$registro['id'].'" style="display:'.$btn_seguir_display.'" class="btn btn-success btn_seguir" data-id_usuario="'.$registro['id'].'">Seguir</button>';
		...
		echo 'Erro na consulto dos usuários no banco de dados';
	}
?>